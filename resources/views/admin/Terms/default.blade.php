          ...
          <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                         ...
                         <form id="form"action="{{route('editor_add')}}" method="post" enctype="multipart/form-data">
          ...
          <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                         ...
                         <form id="replaceLineBreaks" action="{{route('editor_edit')}}" method="post" enctype="multipart/form-data">
                            <input type="hidden" value="{{ csrf_token() }}" name="_token">  
                                    ...
                                    <label>Descriuption</label>
                                     <textarea cols="80" rows="10" id="myTextarea" name="description" value="{{$editor->description}}">
                                        <span style=\"font-size: 20px;\"></span>
                                            <span style=\"color: rgb(255, 140, 0);\">     {{$editor->trems_condi}}</span>
                                     </textarea>
