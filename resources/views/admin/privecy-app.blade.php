...
@section('title')
{{__("message.Privecy")}}  | Admin Dashboard
@stop
@section('meta-data')
@stop
@section('content')
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              @endif
              <strong class="card-title">{{__("message.Privecy")}} </strong>
                      ...
                      <div class="modal-content">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{url('edit_app_privacy')}}" method="post" enctype="multipart/form-data">
                              {{csrf_field()}} 
